...
public class Chrome_Activity3b {
	WebDriverWait wait;
	...
	public void chromPopupsFail() {
		...
		boolean confirmLogin = (boolean) wait
				.until(ExpectedConditions.elementToBeClickable(MobileBy.xpath("//*[contains(@text,'Invalid Credentials')]"))).isDisplayed();
